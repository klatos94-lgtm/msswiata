      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-5">
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-sm text-slate-600 space-y-1.5">
            <li>Obstawki są utajnione.</li>
            <li>Wyniki aktualizują się co 2 godziny w zakładce <strong>Ranking</strong>.</li>
            <li>Indywidualne statystyki zawodnika wyświetlone są w zakładce <strong>Dashboard</strong>.</li>
          </ul>
        </div>
