...
BEGIN
  ...
  WITH group_teams (team, group_label) AS (
    VALUES
      ...
      ('Haiti', 'C'), ('Szkocja', 'C'), ('Brazylia', 'C'), ('Maroko', 'C'),
      ('USA', 'D'), ('Paragwaj', 'D'), ('Australia', 'D'), ('Turcja', 'D'),
      ('Niemcy', 'E'), ('Curacao', 'E'), ('Wybrzeże Kości Słoniowej', 'E'), ('Ekwador', 'E'),
      ('Holandia', 'F'), ('Japonia', 'F'), ('Szwecja', 'F'), ('Tunezja', 'F'),
      ('Belgia', 'G'), ('Egipt', 'G'), ('Iran', 'G'), ('Nowa Zelandia', 'G'),
      ('Hiszpania', 'H'), ('Republika Zielonego Przylądka', 'H'), ('Arabia Saudyjska', 'H'), ('Urugwaj', 'H'),
