  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl px-4">
        ...
        <p className="text-emerald-100 text-lg sm:text-xl mb-10 max-w-lg mx-auto drop-shadow">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/login"
            className="bg-white hover:bg-amber-50 text-emerald-800 px-8 py-3.5 rounded-xl font-semibold shadow-lg transition transform hover:scale-105"
          >
            Zaloguj się
          </Link>
          <Link
            href="/leaderboard"
            className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-8 py-3.5 rounded-xl font-semibold border border-white/40 shadow-lg transition transform hover:scale-105"
          >
            Ranking
          </Link>
        </div>
